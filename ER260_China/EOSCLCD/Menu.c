...
//{ SETPROM   ,(*),ApplVar..Name,&number,&Max,0,0},//中奖设置
    ...
    { SETTAX    ,(*ReadTax),    (char*)ApplVar.Tax.Name,    (WORD*)&ApplVar.TaxNumber,      (WORD*)&MaxNum6,0,0},  //jdb2018-04-18 最后两种税不用配置【零税、免税】
#endif
/* MENUICCMAX:IC卡管理*/
...
#else //jdb2018-03-22 增加到40行
	{ SETHEAD	,(*ReadHeader), (char*)ListRecord.Name, 	(WORD*)&ListRecord.Number,		(WORD*)&MaxNum40,0,0},	 //收据票头
	{ SETTRAIL	,(*ReadTrail),	(char*)ListRecord.Name, 	(WORD*)&ListRecord.Number,		(WORD*)&MaxNum40,0,0},//收据票尾
#endif
