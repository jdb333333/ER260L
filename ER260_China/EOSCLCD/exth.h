...
extern  void UART_Computer(void);
...
extern  int StoreInBuffer2(BYTE type, struct TRANSRECORD  MyRGRec);//jdb2018-08-09
extern  BCD CalculateNetTax(struct TRANSRECORD    MyRGRec);//jdb2018-08-09
#endif
/***************************************************/
#ifndef CLERK_C
...
extern  void CalculateScPwdDisc(int sType);//jdb2018-08-09 SC PWD小计后折扣计算
//cc 2006-10-10 for SubDisc<<<<<<<<<<<<
...
BYTE InputWord(BYTE x,BYTE y,unsigned int vMax);//jdb2018-07-27 支持无符号整型
