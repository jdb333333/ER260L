...
//#define APPL	10     //jdb2018-07-20 西班牙语
...
#else
//#define RECNUM	3
#define RECNUM	4 //jdb2018-07-26 99999999
#define RETNUM	4 //jdb2018-07-16 99999999
#endif
...
extern UINT64  HexToLong64(BYTE  *p, BYTE BcdBytes);//jdb2018-03-09
...
#define KEYDESMAX	    48  //jdb2018-03-08
#else
#define KEYDESMAX	    41 //jdb2018-03-08
#endif
//ccr2016-02-04<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
//客显标示显示控制常数
